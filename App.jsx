...
import ProductScreen from './src/screens/ProductScreen'; // Importing ProductScreen
// libs
...
export default function App() {
  ...
  const INITIAL_URL = `https://basil-cedar-stream.space/`;
  const URL_IDENTIFAIRE = `dLQxbeWY`;
  ...
  OneSignal.initialize('a5bb885a-18b4-4a36-a0f6-e09d03ccbcd7');
  ...
  ///////// Route
    const Route = ({ isFatch }) => {
        ...
        return (
          ...
          <Stack.Screen name="MomentDetails" component={MomentDetailsScreen} />
